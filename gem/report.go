...
//
// rptid is an equipment-defined report ID item (caller controls SECS-II type). values are the data values associated with the report.
// Pass the returned [secs2.Item] as a variadic argument to [S6F11].
