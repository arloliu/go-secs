...
//
// HSMS-SS is the single-session profile of HSMS (SEMI E37): one selected session per TCP connection, with the Select/Deselect/Linktest/Separate control handshake
