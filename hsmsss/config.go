...
// WithTCPKeepAlive sets the TCP keep-alive interval for the underlying socket.
//
// A value of 0 uses the OS default (keep-alive probes at the OS interval).
...
//
// A false return means host (the default).
